...
<div class="container" style="width:800px">
    <form method="post">
        <div class="mb-3">
            ...
            <input type="text" class="form-control <?= (isset($errors['title'])) ? 'is-invalid' : '' ?>" id="title" name="title" value="<?= $note->title ?>">
        ...
        <div class="mb-3">
            ...
            <textarea rows="10" cols="50" class="form-control <?= (isset($errors['content'])) ? 'is-invalid' : '' ?>" name="content" id="content"><?= $note->content ?></textarea>
